...
export default function Contact() {
  return (
    <div className='w-1/2 flex flex-col justify-center relative pl-10'>
      <h1 className='text-6xl flex flex-row items-center mb-2'>
        <span className='bg-yellow-400 px-3 rounded-lg'>Contact Me</span>
      </h1>
      <h2 className='text-4xl py-2'>Get in <span className='text-red-500 font-bold'>Touch</span></h2>
      ...
      <div className='mt-6 space-y-4'>
        <div className='flex items-center'>
          ...
          <span className='text-lg'>lina.joshuacruz@gmail.com</span>
        </div>
        <div className='flex items-center'>
          <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6 mr-3">
          ...
          <span className='text-lg'>Nueva Ecija, Philippines</span>
        </div>
        <div className='flex items-center'>
          <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6 mr-3">
            <path strokeLinecap="round" strokeLinejoin="round" d="M2.25 6.75c0 8.284 6.716 15 15 15h2.25a2.25 2.25 0 0 0 2.25-2.25v-1.372c0-.516-.351-.966-.852-1.091l-4.423-1.106c-.44-.11-.902.055-1.173.417l-.97 1.293c-.282.376-.769.542-1.21.38a12.035 12.035 0 0 1-7.143-7.143c-.162-.441.004-.928.38-1.21l1.293-.97c.363-.271.527-.734.417-1.173L6.963 3.102a1.125 1.125 0 0 0-1.091-.852H4.5A2.25 2.25 0 0 0 2.25 4.5v2.25Z" />
          </svg>
          <span className='text-lg'>+63 995 741 0607</span>
        </div>
      </div>
    </div>
  );
